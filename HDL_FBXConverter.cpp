#include "HDL_FBXConverter.h"
#include <cassert>
#include <algorithm>
#include <fstream>

void HDL_FBXConverter::ConvertFBX(
	const char* fbxFile,
	const char* textFile,
	float fx,
	float fy,
...
void HDL_FBXConverter::LoadMaterial(FbxSurfaceMaterial* material)
{
	Material tmp;
	FbxDouble3 colors;
	FbxProperty prop;
...
void HDL_FBXConverter::LoadPosition(FbxMesh* mesh, int k)
{
	//Vertex Coordinate
...
void HDL_FBXConverter::LoadNormals(FbxMesh* mesh, int k)
{
...
void HDL_FBXConverter::LoadTexcoords(FbxMesh* mesh, int k)
{
...
void HDL_FBXConverter::LoadIndices(FbxMesh* mesh, int k)
{
...
void HDL_FBXConverter::LoadMaterialName(FbxMesh* mesh, int k)
{
	//None Material
...
void HDL_FBXConverter::CreateTextCombineVertex(const char* textFile, float fx, float fy, float fz)
{
